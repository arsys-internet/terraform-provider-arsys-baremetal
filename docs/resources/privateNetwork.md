...
sidebar_current: "docs-resource-private_network"
description: |-
  Creates and manages Private Networks in Arsys Baremetal.
---

# arsys-baremetal\_private\_network
...
* `datacenter_id` - (Required) ID of the datacenter where the private network will be created.
...
Resource Private Network can be imported using creating the resource the `resource ID`,
