...
func (p *BaremetalProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewPrivateNetworkServersAssignResource,
		NewPrivateNetworkServerRemoveResource,
		NewPublicIpResource,
		NewPublicNetworkIpsResource,
...
func (p *BaremetalProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewPrivateNetworkServerDataSource,
		NewPrivateNetworkServersDataSource,
		NewPublicIpDataSource,
		NewPublicIpsDataSource,
		NewPublicNetworkDataSource,
		NewPublicNetworkIpDataSource,
		NewPublicNetworkIpsDataSource,
